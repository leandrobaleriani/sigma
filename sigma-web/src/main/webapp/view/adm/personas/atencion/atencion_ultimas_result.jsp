...
<div class="panel-body">
	<div class="list-group">
		<s:iterator value="#request.atencionesUltimas" var="atencion">
			<a href="javascript:diagnosticar('<s:property value="id" />');void(0);" class="list-group-item"><span
				class="glyphicon glyphicon-ok"></span>&nbsp;&nbsp; <b><s:property
						value="persona.apellido" />&nbsp;<s:property
						value="persona.nombre" /> (<s:property value="tipoAtencion" />)</b>
				<br /> FECHA ATENCIÓN: <b><s:date name="finAtencion"
